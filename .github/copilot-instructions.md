...
- TypeScript 5.x with React 18 and Next.js 14 + Next.js, React, MUI, Zustand, three, @react-three/fiber, @react-three/drei, Jest, Testing Library (008-optimize-animation-smoothness)
- N/A for feature data persistence; runtime in-memory state via Zustand (008-optimize-animation-smoothness)
...
## Recent Changes
- 008-optimize-animation-smoothness: Added TypeScript 5.x with React 18 and Next.js 14 + Next.js, React, MUI, Zustand, three, @react-three/fiber, @react-three/drei, Jest, Testing Library
